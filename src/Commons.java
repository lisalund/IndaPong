...
public interface Commons {
	...
	public final static int fieldHeigth = 450; //the height of the playing filed
	public final static int PADDLEPADDING = 20; //distance between edge of playing field and the paddle
}
